// from https://github.com/StoneCypher/four_color.js/blob/master/src/four_color.js
function gen4col_bt(solutions, vertices, whichVertex, work, stopAtOne) { // generate a 4-coloring through backtracking
    ...
    for (let color = 0; color < 4; ++color) {
        ...
        for (let neighbor = 0, neighborCap = vertices[whichVertex].neighbors.length;
            ((neighbor < neighborCap) && (!color_burned)); ++neighbor) {
